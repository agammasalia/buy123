angular.module('ProductsDetailCtrl', []).controller('ProductsDetailCtrl', ['$scope', '$routeParams', '$http', function($scope, $routeParams, $http) {
	...
	.success(function(data) {
		...
		$scope.url = "http://localhost:8080/buy123/LoginForm.jsp?collection="+$routeParams.products+"&_id="+$routeParams.id;
	})
	.error(function(data) {
